          ...
          <div className="col-xl-6 col-lg-6">
            <div className="feature__area-left">
              <div className="feature__area-left-title">
                ...
                <p>
                Indulge in a delightful dining experience at our amazing restaurant, where exquisite flavors, fresh ingredients, and warm hospitality come together to create unforgettable meals.
                </p>
